...
<div class="radio-inline">
    <label>
        <input type="radio" name="gender" value="2" @if(Request::old('gender')=="2") checked @endif>女性
    </label>
    <span class="help-block">{{$errors->first('radio')}}</span>
...
<div class="textarea @if(!empty($errors->first('note'))) has-error @endif">
    <textarea type='text' name="note" cols="30" rows="10" placeholder="ご自由に入力ください。">{{Request::old('note')}}</textarea>
